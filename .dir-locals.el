((prog-mode
  . ((mode . flycheck)
	 ...
	 (c-offsets-alist . ((annotation-var-cont . +)
						 ...
						 (lambda-intro-cont . +)
						 (member-init-intro . +)
;; https://hexmode.com/2016/12/how-i-chased-down-a-php-mode-indention-bug-in-emacs/
 ...
 (json-mode .
	 ((eval . (progn (when (fboundp 'delete-trailing-whitespace)
			   ...
			   (when (fboundp 'subword-mode)
				 (subword-mode))))))
 (php-mode . ((flycheck-phpcs-standard . "/home/mah/work/code/mediawiki/codesniffer/MediaWiki")
